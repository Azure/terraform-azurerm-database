...
| [azurerm_sql_active_directory_administrator.aad_admin](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/sql_active_directory_administrator) | resource |
...
| <a name="input_create_resource_group"></a> [create\_resource\_group](#input\_create\_resource\_group)    | Create a new resource group with name `var.resource_group_name`, or just use it as resource group's name. Default to `true`. Changing this forces a new resource to be created.                                                                                                                                                                                                                                             | `bool`                                                                                                                                                                                                              | `true`                                             |    no    |
...
| <a name="input_sql_aad_administrator"></a> [sql\_aad\_administrator](#input\_sql\_aad\_administrator)    | object({<br>  login = (Required) The login name of the principal to set as the server administrator<br>  object\_id = (Required) The ID of the principal to set as the server administrator<br>  tenant\_id = (Required) The Azure Tenant ID<br>  azuread\_authentication\_only = (Optional) Specifies whether only AD Users and administrators can be used to login (`true`) or also local database users (`false`).<br>}) | <pre>object({<br>    login                       = string<br>    object_id                   = string<br>    tenant_id                   = string<br>    azuread_authentication_only = optional(bool)<br>  })</pre> | `null`                                             |    no    |
